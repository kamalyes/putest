...
from putest.common import Var, Dict, log_info
from putest.common.decorator import mach_keywords, executor_keywords
from putest.runner.action_executor_app import ActionExecutorApp
from putest.runner.action_executor_web import ActionExecutorWeb
        ...
        while True:
            if isinstance(content, str):
                ...
                if search_contains:
                    ...
                    content = content[0:search_contains.span()[0]] + search_name + content[
                                                                                   search_contains.span()[
                                                                                       1]:]
                else:
                    break
            else:
