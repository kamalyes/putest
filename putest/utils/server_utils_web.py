...
class ServerUtilsWeb(object):
    ...
    def __init__(self, desired_capabilities):
        ...
        # driver path
        if self.desired_capabilities[self.browser] and 'driver' in self.desired_capabilities[
            self.browser].keys():
        ...
        # options
        if self.desired_capabilities[self.browser] and 'options' in self.desired_capabilities[
            self.browser].keys():
